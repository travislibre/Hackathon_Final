...
# $ D:/Downloads/opencv/build/x64/vc15/bin/opencv_annotation.exe --annotations=pos.txt --images=positive/
...
#$ C:/Users/tjlib/Downloads/thing2/opencv/build/x64/vc15/bin/opencv_annotation.exe --annotations=pos.txt --images=positive/
#$ C:/Users/tjlib/Downloads/thing2/opencv/build/x64/vc15/bin/opencv_createsamples.exe -info pos.txt -w 24 -h 24 -num 1000 -vec pos.vec
#$ C:/Users/tjlib/Downloads/thing2/opencv/build/x64/vc15/bin/opencv_traincascade.exe -data cascade/ -vec pos.vec -bg neg.txt -precalcValBufSize 6000 -precalcIdxBufSize 6000 -numPos 3 -numNeg 1000 -numStages 12 -w 10 -h 10 -maxFalseAlarmRate 0.4 -minHitRate 0.999
#$ python main.py